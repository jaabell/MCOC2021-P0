...
fid = open("MatrizLlena,double(solve).txt","w") #vario el nombre dependendiendo del caso para lograr los archivos txt
time=1
while time<=10:
    print(time)
    time+=1
    ...
    for N in ListNs:    
        ...
        mul=solve(a,b) #este solamente lo ocupamos para caso matriz llena
