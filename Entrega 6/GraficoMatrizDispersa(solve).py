...
ListM=[]
ListUsoMemoria=[]
fid = open("MatrizDispersa,double(solve).txt","r")
n=0
l1=[]
l2=[]
l3=[]
...
x=[2,5,10,15,20,25,50,100,200,500,1000,2000,5000,10000,20000,30000,35000]
#
labels_x = [2,5,10,15,20,25,50,100,200,500,1000,2000,5000,10000,20000,30000,35000]
Ns = [2,5,10,15,20,25,50,100,200,500,1000,2000,5000,10000,20000,30000,35000]
