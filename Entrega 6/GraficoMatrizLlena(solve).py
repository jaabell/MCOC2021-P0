...
"""
Created on Fri Aug 20 17:08:20 2021
@author: matia
"""
...
fid = open("MatrizLlena,double(solve).txt","r")
n=0
l1=[]
l2=[]
l3=[]
...
x=[2,5,10,15,20,25,50,100,200,500,1000,2000,5000,10000,20000]
#
labels_x = [2,5,10,15,20,25,50,100,200,500,1000,2000,5000,10000,20000]
Ns = [2,5,10,15,20,25,50,100,200,500,1000,2000,5000,10000,20000]
...
plt.loglog([2,20000],[max1,max1],marker=' ', color='b', linestyle='--', label = "Constante")
plt.loglog([2,20000],[fx,max1],marker=' ', color='orange', linestyle='--', label = "O(N)")
plt.loglog([500,20000],[fx,max1],marker=' ', color='g', linestyle='--', label = "O(N^2)")
plt.loglog([2000,20000],[fx,max1],marker=' ', color='r', linestyle='--', label = "O(N^3)")
plt.loglog([2000 ,20000],[fx,max1],marker=' ', color='m', linestyle='--', label = "O(N^4)")
...
plt.loglog([2,20000],[max2,max2],marker=' ', color='b', linestyle='--', label = "Constante")
plt.loglog([2,20000],[fx,max2],marker=' ', color='orange', linestyle='--', label = "O(N)")
plt.loglog([200,20000],[fx,max2],marker=' ', color='g', linestyle='--', label = "O(N^2)")
plt.loglog([1000,20000],[fx,max2],marker=' ', color='r', linestyle='--', label = "O(N^3)")
plt.loglog([2000 ,20000],[fx,max2],marker=' ', color='m', linestyle='--', label = "O(N^4)")
plt.legend(loc="upper left")
