# -*- coding: utf-8 -*-
"""
Created on Fri Aug 20 19:19:07 2021
...
A1=promediolist("casoI,double.txt")    
          
A2=promediolist("casoII,double.txt") 
             
#A3=promediolist("casoIII,float.txt")    
       
A4=promediolist("casoIV,double.txt") 
      
A5=promediolist("casoV,double.txt")    
A6=promediolist("casoVI,double.txt")    
A7=promediolist("casoVII,double.txt")    

B1=promediolist("casoB(I),double.txt")    
B2=promediolist("casoB(II),double.txt")    
B3=promediolist("casoB(III),double.txt")    
B4=promediolist("casoB(IV),double.txt")    
#B5=promediolist("casoB(V),double.txt")  
