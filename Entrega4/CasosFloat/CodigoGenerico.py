...
fid = open("casoVI,float.txt","w") #vario el nombre dependendiendo del caso para lograr los archivos txt
...
while time<=10:
    ...
    for N in ListNs:    
        ...
        a=laplaciana(N,dtype=float) #dependiendo el caso lo cambio para float o double
        b=ones(N)
        t2 = perf_counter()
        #print(A)
        am1= inv(a)
