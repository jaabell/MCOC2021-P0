...
ListNs=[2,5,10,15,20,25,50,100,200,500,1000,2000,5000,10000,20000]
#
ListDtsInversion=[]
ListDtsEnsamblaje=[]

fid = open("MatrizLlena,double.txt","w") #vario el nombre dependendiendo del caso para lograr los archivos txt
time=1
while time<=10:
    print(time)
    time+=1
